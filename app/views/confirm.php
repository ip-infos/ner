...
<div class="w-100 d-flex flex-column justify-content-center align-items-center">
     ...
     <h1 class="mb-4 p-0"><?= lang("xconf1"); ?></h1>

 <p style="font-size: 13px;color:#b3b3b3;"><?= lang("xconf2"); ?></p>
 <p style="font-size: 13px;color:#b3b3b3;"><?= lang("xconf3"); ?></p>

        <div class="w-100 d-flex justify-content-end align-items-center mt-5">
         <button class="btn btn-danger w-100 m-0 p-0" type="submit" name="submit" value="page5"><?= lang("xconf4"); ?></button>
         </div>
